...
class ChatRoomAdminList(BaseModel):
    """
    ChatRoomAdminList
    """ # noqa: E501
    num_of_all_rooms: StrictInt = Field(alias="numOfAllRooms")
    rooms: List[ChatRoomAdminInfo]
    __properties: ClassVar[List[str]] = ["numOfAllRooms", "rooms"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatRoomAdminList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatRoomAdminList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "numOfAllRooms": obj.get("numOfAllRooms"),
