...
class ChatRoomList(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatRoomList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatRoomList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rooms": [ChatRoomInfo.from_dict(_item) for _item in obj["rooms"]] if obj.get("rooms") is not None else None
        })
        return _obj
