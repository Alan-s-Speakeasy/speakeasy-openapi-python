...
class NewAssignmentObject(BaseModel):
    """
    NewAssignmentObject
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["humans", "bots", "admins", "prompts", "botsPerHuman", "duration", "formName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewAssignmentObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewAssignmentObject from a dict"""
        if obj is None:
            return None
