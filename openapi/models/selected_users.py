...
class SelectedUsers(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["humans", "bots", "admins", "evaluator", "assistant"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SelectedUsers from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SelectedUsers from a dict"""
        if obj is None:
            return None
